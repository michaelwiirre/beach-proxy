...
export function resolveSatelliteClarity(erddapJson, requestTimestamp) {
  try {
    ...
    if (ageHoursCheck < 0 || ageHoursCheck > 240) return null; // older than 10 days -- too stale to call "current"
...
export const MODEL_IMPLEMENTATION_FINGERPRINT = "a0ebe9b5107871ba";
