...
// ERDDAP). This integration could NOT be live-tested against a real
// ERDDAP response before deployment (no network access available while
// building it) — the dataset ID, variable name, and dimension order
// below are based on ERDDAP's documented griddap conventions plus one
// confirmed real example query, but the exact response may need
// debugging against what actually comes back. Queries a 5-day window
// (not a single day) since cloud cover can blank out any individual
// day's pass; resolveSatelliteClarity (shared-model.js) picks the most
// recent non-null reading in whatever comes back.
// ---------------------------------------------------------------------
const ERDDAP_KD490_BASE = "https://coastwatch.pfeg.noaa.gov/erddap/griddap/nesdisVHNSQkd490Daily.json";
